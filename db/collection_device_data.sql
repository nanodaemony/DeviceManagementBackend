...
CREATE TABLE `data_mei_dun_li_5100c` (
    ...
    `oxygen_saturation_l` double DEFAULT NULL,
    `oxygen_saturation_r` double DEFAULT NULL,
    `oxygen_saturation_s1` double DEFAULT NULL,
    `oxygen_saturation_s2` double DEFAULT NULL,
    `event_l` double DEFAULT NULL,
    `event_r` double DEFAULT NULL,
    `event_s1` double DEFAULT NULL,
    `event_s2` double DEFAULT NULL,
    `status_l` double DEFAULT NULL,
    `status_r` double DEFAULT NULL,
    `status_s1` double DEFAULT NULL,
    `status_s2` double DEFAULT NULL,
    `base_l` double DEFAULT NULL,
    `base_r` double DEFAULT NULL,
    `base_s1` double DEFAULT NULL,
    `base_s2` double DEFAULT NULL,
    `auc_l` double DEFAULT NULL,
    `auc_r` double DEFAULT NULL,
    `auc_s1` double DEFAULT NULL,
    `auc_s2` double DEFAULT NULL,
    `ual_l` double DEFAULT NULL,
    `ual_r` double DEFAULT NULL,
    `ual_s1` double DEFAULT NULL,
    `ual_s2` double DEFAULT NULL,
    `lal_l` double DEFAULT NULL,
    `lal_r` double DEFAULT NULL,
    `lal_s1` double DEFAULT NULL,
    `lal_s2` double DEFAULT NULL,
    `a_l` double DEFAULT NULL,
    `a_r` double DEFAULT NULL,
    `a_s1` double DEFAULT NULL,
    `a_s2` double DEFAULT NULL,
    `b_l` double DEFAULT NULL,
    `b_r` double DEFAULT NULL,
    `b_s1` double DEFAULT NULL,
    `b_s2` double DEFAULT NULL,
    `c_l` double DEFAULT NULL,
    `c_r` double DEFAULT NULL,
    `c_s1` double DEFAULT NULL,
    `c_s2` double DEFAULT NULL,
