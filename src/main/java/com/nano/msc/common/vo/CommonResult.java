...
public class CommonResult<T> implements Serializable {
    ...
    public static <T> CommonResult<ExceptionEnum> failed(ExceptionEnum exceptionEnum) {
        return new CommonResult<>(ResultCodeEnum.FAILED.getCode(), exceptionEnum.getMessage(), exceptionEnum);
    }
     ...
     * 失败返回结果
     */
    public static <T> CommonResult<T> failed(ExceptionEnum exceptionEnum, T message) {
        return new CommonResult<>(ResultCodeEnum.FAILED.getCode(), exceptionEnum.getMessage(), message);
    }
